...
def save_changes(phonebook_dict: List[list]) -> None:
...
def find_choose(phonebook_dict: List[list]) -> None:
    while True:
...
def add_numb(phonebook_dict: List[list]) -> None:
    number = input("number:\t")
...
def change(phonebook_dict: List[list], i: list) -> None:
    print("telephone number:", i[0], "\nfirst name:", i[1], "\nlast name:", i[2], "\ncity:",
          i[3], "\nstate:", i[4])
    while True:
...
def delete(count: int, phonebook_dict: List[list]) -> None:
    phonebook_dict.remove(phonebook_dict[count])
    save_changes(phonebook_dict)
    stay_or_not()


def choose(count: int, phonebook_dict: List[list], i: list) -> None:
    while True:
